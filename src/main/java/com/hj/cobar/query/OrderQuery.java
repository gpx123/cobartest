...
public class OrderQuery extends BaseQuery {
	...
	public OrderQuery setId(Long id) {
		this.id = id;
		return this;
	}
	...
	public OrderQuery setTaobaoId(Long taobaoId) {
	...
	public OrderQuery setNameLike(boolean nameLike) {
	 ...
	 *            是否升序，否则为降序
	 */
	public OrderQuery orderbyTaobaoId(boolean isAsc) {
	 ...
	 *            是否升序，否则为降序
	 */
	public OrderQuery orderbyUpdTime(boolean isAsc) {
